...
class VendedoresController extends Controller
{
	...
	public function porcobrar()
	{
			...
			->select(DB::raw('SUM(v.saldo) as acumulado'),'ve.nombre as vendedor','ve.cedula','ve.telefono')
			->groupby('ve.id_vendedor')
			->where('v.saldo','>',0)
			->paginate(10);
			//dd($pacientes);
			return view('vendedor.cobrar.index',["vendedores"=>$pacientes,"empresa"=>$empresa]);
