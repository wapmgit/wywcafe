...
$this->middleware('auth');
	...
	$empresa=DB::table('empresa')-> where('idempresa','=','1')->first();
		...
		-> join ('vendedores as ve','ve.id_vendedor','=','v.idvendedor')
		  ...
		  // ->groupby('r.idventa')
            ...
            return view("comisiones.comision.show",["regla"=>$regla,"recibos"=>$recibos,"venta"=>$venta,"vendedor"=>$vendedor,"empresa"=>$empresa]);
}
  public function update(Request $request){
   ...
   $venta-> save();
	...
	//dd($vendedor);
	$empresa=DB::table('empresa')-> where('idempresa','=','1')->first();
            return view("comisiones.comision.xpagar",["monedas"=>$monedas,"vendedor"=>$vendedor,"empresa"=>$empresa]);
}
