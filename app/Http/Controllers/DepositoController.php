...
$rol=DB::table('roles')-> select('vacios')->where('iduser','=',$request->user()->id)->first();
			...
			->first();
            return view('almacen.deposito.index',["rol"=>$rol,"cntvacios"=>$cntvacios,"articulo"=>$articulo,"categorias"=>$categorias,"searchText"=>$query]);
