...
<div class="row" id="search" style="display: true">
	<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
		<h3>Indique Mes para el Reporte</h3>
		@include('reportes.inventariofechaarticulo.search')
	</div>
</div>
...
<div class="row">
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h4 class="box-title"><small><b>REGISTRO DETALLADO DE ENTRADAS Y SALIDAS DE INVENTARIO DE MERCANCIAS (MATERIAS PRIMAS O PRODUCTOS EN PROCESO)</b></small></h4>
	  ...
	  ?> @include('reportes.inventariofechaarticulo.empresa')
...
$(document).ready(function(){
  ...
  window.print(); 
  window.location="/reportes/inventariofecha";
    });
