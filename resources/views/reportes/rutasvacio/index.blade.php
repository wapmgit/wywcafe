...
<div class="row" id="search" style="display: true">
	<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
		@include('reportes.rutasvacio.search')
	</div>
</div>
...
<div class="panel-body">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    @include('reportes.rutasvacio.empresa')
    <h3 align="center">Clientes con Vacios en  Ruta {{$ruta}}</h3> 
  </div>
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
  <div>
<table width="95%">
						...
						<?php $count++; $agg=0; $rece=0;?>
							<tr style="background-color: #E8f5e9">
								<td><small><small><b>{{$cat->nombre}}</b></small></small></td>
		...
		@foreach	($mov as $m)
									<?php if(($cat->id_cliente == $m->id_persona) and ($m->debe>0)){ $acumvacio= $acumvacio+ $m->debe; ?>						
					...
					@endforeach
							...
							<td colspan="2"><strong>Vacios: </strong><?php echo $acumvacio; ?></td>
