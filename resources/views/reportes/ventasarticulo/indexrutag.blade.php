...
<?php echo $ruta; ?>
 ...
 <!--     <table class="table table-striped table-bordered table-condensed table-hover">
      ...
      <table class="table table-striped table-bordered table-condensed table-hover">
	   ...
	   <?php } ?>
        @endforeach
		<tr><td colspan="4" align="right"><strong> Total Venta:</strong></td><td><strong><?php echo $acumcnt." Unds"; ?></strong></td><td><strong><?php echo number_format(($tventa), 2,',','.')." $"; ?></strong></td></tr>
      </table>
	  </div>
