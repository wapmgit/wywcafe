...
<?php  $fecha=date("Y-m-d"); $acum=0;?>
			   ...
			   <div class="col-lg-12 col-md-12 col-sm-6 col-xs-12">
			   	<h3 align="center"> DETALLE TOSTADOR</h3>
				</div>
...
<table border="1" width="100%" >
		...
		<div class="col-lg-12 col-md-12 col-sm-6 col-xs-12">
			...
			{!!Form::open(array('url'=>'produccion/tostador/pagar','method'=>'POST','autocomplete'=>'off','id'=>'formulario'))!!}
            {{Form::token()}}
     <div class ="row" id="divdesglose" style="display: none">
		 ...
		 <input type="hidden" value="{{$tosta->id}}"  name="proveedor" class="form-control">
