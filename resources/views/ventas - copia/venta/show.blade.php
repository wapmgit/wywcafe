	...
	<td> <b> <small>N° lICENCIA:  </small></b> </br>{{$venta->licencia}}</td><td><small>FORMA DE PAGO:</small></td>
       ...
       <div class ="row">                                         
                  ...
                  <table width="100%" BORDER="1">
                      ...
                      <tfoot>                      
                          <th colspan="4">TOTAL: <small> Cuenta Anterior</small>: -><?php echo "$ ".number_format((($cxc+$notasnd)- ($notasnc+$venta->total_venta)), 2,',','.'); ?> <small> factura Actual</small>: -> <?php echo " $".number_format($venta->total_venta, 2,',','.'); ?> CXC:-> <?php echo "$ ".number_format((($cxc+$notasnd)- $notasnc), 2,',','.'); ?> 
