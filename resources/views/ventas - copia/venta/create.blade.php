                ...
                <div class="panel-body">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                        <div class="form-group">
                             ...
                             @foreach ($articulos as $articulo)
                              <option value="{{$articulo -> idarticulo}}_{{$articulo -> stock}}_{{$articulo -> precio_promedio}}_{{$articulo -> precio2}}_{{$articulo -> costo}}_{{$articulo->iva}}">{{$articulo -> articulo}}</option>
                             @endforeach
                              </select>
                        </div>
					</div>
                  ...
                  <table id="detalles" class="table table-striped table-bordered table-condensed table-hover">
                      ...
                      <th><a href="javascript:aggadm();">Total</a></th>
                          <th>Exe:<input type="number" style="width: 60px" readonly name="totalexe" id="texe"></th>
                          <th>Cto:<input type="number" style="width: 60px" readonly name="totalc" id="totalc"></th>
                          <th>IVAf:<input type="number" style="width: 60px" readonly name="total_ivaf" id="total_ivaf"></th>
                          <th>IVA:<input type="number" style="width: 60px" readonly name="total_iva" id="total_iva"></th>
    ...
    function agregar(){
      ...
      var cantidad=0; var stock=0;
        ...
        if (idarticulo!="" && cantidad != "" &&  precio_venta!=""){
                ...
                if (cantidad <= stock){	subexe[cont]=0;
					if(alicuota>0){subiva[cont]=((cantidad*precio_venta)-((cantidad*precio_venta)/((alicuota/100)+1)));
					subivaf[cont]=((cantidad*(costoarticulo*1.01))-((cantidad*(costoarticulo*1.01))/((alicuota/100)+1)));
					}else{
						subexe[cont]=precio_venta;
						subivaf[cont]=0; subiva[cont]=0;}
					
					totaliva=totaliva+subiva[cont];
					totalexe=totalexe+subexe[cont];
					
					totalivaf=totalivaf+subivaf[cont];
					subdif[cont]=difadm;
					acumadm=acumadm+difadm;
                subtotal[cont]=((cantidad*precio_venta)-descuento);
                subtotalc[cont]=((cantidad*costoarticulo)*((1/100)+1));
