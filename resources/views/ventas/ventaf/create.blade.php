...
?>     @foreach ($contador as $p)
	...
	<div class="row" style="background-color:#7DCEA0"> 
		<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
			<h3>Venta Forma Libre</h3>
			@if (count($errors)>0)
		...
		<div class="inner">
           <h1 id="muestramontobs" align="center"><sup style="font-size: 25px"><?php ?>Bs   0.00</sup></h1>
			...
			{!!Form::open(array('url'=>'ventas/ventaf','method'=>'POST','id'=>'form','autocomplete'=>'off'))!!}
            {{Form::token()}}
            <div class="row" style="background-color:#7DCEA0">
            ...
            <div class ="row" id="divarticulos" style="display: true">
                ...
                <div class="panel-body">
                  ...
                  <table id="detalles" class="table table-striped table-bordered table-condensed table-hover">
                      ...
                      <tfoot> 
                      <th><a href="javascript:aggadm();">Total</a></th>
					...
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4" style="display: none" id="divnc"  align="right">
						...
						<div class="col-lg-6 ol-md-6 col-sm-6 col-xs-6"  id="cfl">
							¿ Formato Monto Total ? <input type="checkbox"  checked name="convertir" />
							¿ formato 1% ? <input type="checkbox"  name="formato" />
							
							</div>
						<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8" id="botones"  align="right">
						  <div class="form-group">
								<button class="btn btn-primary" id="guardar" type="submit" accesskey="l">Tota<u>l</u>izar</button>
   ...
   $('#btncancelar').click(function(){	
    ...
    function agregar(){		
      ...
      var cantidad=0; var stock=0;
		...
		if((lic=="")&(datosarticulo[6]==1)){
	alert('Articulo no Permitido Para el Cliente Seleccionado');
 return;	
}
        if (idarticulo!="" && cantidad != "" &&  precio_venta!=""){
              ...
              var fila='<tr class="selected" id="fila'+cont+'" ><td><button class="btn btn-warning btn-xs"  onclick="eliminar('+cont+');">X</button></td><td><input type="hidden" name="idarticulo[]" value="'+idarticulo+'">'+articulo+'</td><td><input type="number" name="cantidad[]" readonly="true" style="width: 60px" value="'+cantidad+'"></td><td><input type="number" readonly="true" style="width: 80px" name="precio_venta[]" value="'+precio_venta+'"></td><td><input type="number"  name="descuento[]" readonly="true" style="width: 80px" value="'+descuento+'"></td><td>'+subtotal[cont].toFixed(2)+'<input type="hidden" name="costoarticulo[]" readonly="true" value="'+costoarticulo+'"><input type="hidden" name="eslicor[]"  value="'+licor[cont]+'"></td></tr>';
              cont++;   
			  contl++;
			  evaluar();   
