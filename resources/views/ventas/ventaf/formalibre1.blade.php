                      ...
                      <tbody>
                        ...
                        <tr > <?php $cntline++; ?>
						 <td>{{$det->codigo}}</td>
                          ...
                          <td align="right">
						  <?php echo number_format( ($costofbs), 2,',','.'); 
					?>
						  </td>
					  ...
					  <tfoot>   
<tr><td colspan="7" ></td><td align="right"><b>Subtotal Bs: </b></td><td align="right"><b><font size="3"  align="center"><?php echo number_format(($acumsub), 2,',','.'); ?> </b></td></tr>					  				  
					</tfoot>
                  </table>
...
$(document).ready(function(){
	...
	window.location="/ventas/ventaf"; 
		...
		document.body.innerHTML =printcontenido;
	  	window.print();
		  window.location="/ventasf/formalibre/<?php echo $venta->idventa."_1"; ?>";
