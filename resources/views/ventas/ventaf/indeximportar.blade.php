...
?>
<div class="row"><?php $cont=0; $tventa=0; $fserver=date('Y-m-d');?>
	{!!Form::open(array('url'=>'ventasf/procesarnota','method'=>'POST','id'=>'form','autocomplete'=>'off'))!!}
            {{Form::token()}}
	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
		<div class="table-responsive">
			<table class="table table-striped table-bordered table-condensed table-hover" id="tabla">
               ...
               <?php $cont++;
					$tventa=($ven->mivaf*1.16)+$ven->texe;
					$tventa= truncar(($tventa),2);
$newdate=date("d-m-Y",strtotime($ven->fecha_hora));
	...
	Base Imponible: <input type="number" value="0" id="tiva" name="tiva" readonly class="form-control"></input>
