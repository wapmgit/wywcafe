...
role="dialog" tabindex="-1" id="modal-aggdebo-{{$deposito->id_deposito}}">
{!!Form::open(array('url'=>'/almacen/deposito/aggdebo','method'=>'POST','autocomplete'=>'off','id'=>'formula2'))!!}
            {{Form::token()}}
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
                ...
                <h4 class="modal-title">Registrar  Vacios  Reg#{{$deposito->id_deposito}}</h4>
			</div>
